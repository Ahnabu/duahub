...
export const duas: Dua[] = [
  ...
  // ─── GENERAL: Comprehensive Daily Supplications ──────────────────────────
  {
    id: "s-gen-001",
    slug: "sunnah-general-dua-001",
    category: "sunnah",
    subcategory: "general",
    subcategory_label_en: "General Supplications",
    subcategory_label_bn: "সাধারণ দোয়া",
    purpose_en: "General supplication for goodness and protection",
    purpose_bn: "সাধারণ কল্যাণ ও সুরক্ষার দোয়া",
    source: "Various authentic narrations (Hisnul Muslim collection)",
    arabic: "اللّهُمَّ اغْفِرْ لِي وَارْحَمْنِي وَاهْدِنِي وَعَافِنِي وَارْزُقْنِي",
    transliteration: "Allahummaghfir li warhamni wahdini wa 'afini warzuqni.",
    meaning_bn: "হে আল্লাহ! আমাকে ক্ষমা করুন, দয়া করুন, হেদায়েত দিন, নিরাপত্তা দিন এবং রিজিক দিন।",
    meaning_en: "O Allah forgive me, have mercy on me, guide me, grant well‑being and provide for me.",
    tags: ["general", "forgiveness", "guidance", "provision"],
    context_en: "A comprehensive supplication combining forgiveness, mercy, guidance, well‑being, and provision.",
    context_bn: "এটি একটি সমন্বিত দোয়া যাতে ক্ষমা, রহমত, হেদায়েত, নিরাপত্তা ও রিজিক চাওয়া হয়।"
  },
  {
    id: "q-gen-001",
    slug: "quran-general-dua-001",
    category: "quran",
    subcategory: "general",
    subcategory_label_en: "General Supplications",
    subcategory_label_bn: "সাধারণ দোয়া",
...
export const subcategoryMeta: SubcategoryMeta[] = [
  ...
  },
  {
    id: "general",
    slug: "general",
    label_en: "General Supplications",
    label_bn: "সাধারণ দোয়া",
    category: "sunnah",
  },
  {
    id: "general",
